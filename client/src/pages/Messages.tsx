...
const Messages: React.FC = () => {
  ...
  const userName = localStorage.getItem('userName') || 'Je';
  ...
  return (
    <Container>
      <Header>
        ...
        <HeaderSubtitle>Communiceer veilig met verhuurders</HeaderSubtitle>
      </Header>
          ...
          {conversations.length > 0 ? (
            conversations.map((conversation) => (
              ...
              >
                ...
                <ConversationPreview>
                  {conversation.lastMessage.senderType === 'verhuurder' ?
                    `${conversation.lastMessage.verhuurderName}: ` : 'Je: '
                  }
            ...
            <EmptyState>
              ...
              <p>Je hebt nog geen berichten uitgewisseld met verhuurders.</p>
            </EmptyState>
          )}
        </ConversationsList>
          ...
          {selectedConversationData ? (
            <>
              <ChatHeader>
                ...
                <ChatSubtitle>
                  Conversatie met {selectedConversationData.lastMessage.verhuurderName}
                </ChatSubtitle>
              </ChatHeader>

              <MessagesArea>
                {messages.map((message) => (
                  <MessageBubble key={message._id} isOwn={message.senderType === 'user'}>
                    {message.message}
                    <MessageTime isOwn={message.senderType === 'user'}>
